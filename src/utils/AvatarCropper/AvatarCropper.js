...
class Cropper extends React.Component {
  ...
  render () {
    return (
      <div className="AvatarCropper-container">
        <div className="row">
          <canvas
            ref="canvas"
        ...
        <div className='modal-footer'>
          <RaisedButton className='model-footer-cancel' onClick={this.props.onRequestHide}>{this.props.closeButtonCopy}</RaisedButton>
          <RaisedButton className='model-footer-crop' primary={true} onClick={this.handleCrop.bind(this)}>
...
AvatarCropper.defaultProps = { width: 400, height: 400, modalSize: "sm",
                               closeButtonCopy: "Close", cropButtonCopy: "Crop"};
